...
Module `sdkwork-tts` · runtime code `tts` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `tts-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `tts-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `tts-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `tts.sdkwork.com` | 443 ssl + 80 |
