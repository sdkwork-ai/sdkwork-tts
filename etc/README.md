# sdkwork-tts Source Configuration
...
| `appId` | `sdkwork-tts` |
| `runtimeCode` | `tts` |
| Config root | `/etc/sdkwork/tts/` |
| Runtime TOML | `/etc/sdkwork/tts/config.toml` |
| Secrets | `/etc/sdkwork/tts/secrets/` |
| Override | `SDKWORK_TTS_CONFIG_FILE` |
