# Runbook — sdkwork-tts deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-tts-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-tts/bundle`, loads the image, starts
