...
`sdkwork-tts` ships the standard nine `bin/` entrypoints. Shared behavior
...
| Script | Purpose |
| --- | --- |
| `docker-image.sh` | build / push / save / load / update / inspect `registry.sdkwork.com/apps/sdkwork-tts-standalone:<version>` |
